...
class UpdateCTR extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        set_time_limit(0);
        echo 'Running CTR  Update..'.PHP_EOL;
        ...
        */
        ...
        try {
           ...
           ,a.hsai Entry_Time
            ...
            where ((trim(a.dev) = '566' and a.mnat >= $local_limit ) 
            or (trim(a.dev) != '566' and a.mht >= $foreign_limit )) 
           and a.dou >= trunc(sysdate) and trim(a.nat) in ('RETESP', 'VERESP, 'RETDEV', 'VERDEV, 'VIRMAG', 'RPCMON', 'RECMON', 'RETMON')";
