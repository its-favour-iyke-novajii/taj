...
class UpdateFXInward extends Command
{
    /**
     ...
     */
    protected $signature = 'ctr:update-fx-inward';
     ...
     * @var string
     */
    protected $description = 'Use php command line update FX Inward';
    ...
    public function handle()
    {
        ...
        set_time_limit(0);
        echo 'Running Fx Inward Update..'.PHP_EOL;
        ...
        */
        ...
        echo 'Processing FX Inward Core Banking Transactions..'.PHP_EOL;
        try {
            // core connect
           ...
           ,a.hsai Entry_Time
            ...
            where a.mht >= $foreign_limit
            and nvl(devf,'566') not in ('566') and typ='110'
            and trim(nat) IN ('VIRMAG') and trun(dou) >= trunc(sysdate)";
            ...
            while ($row = oci_fetch_assoc($stid)) {
                ...
                */
                ...
                if (($row['NATURE_OF_TRANSACTION'] == 'VIRMAG') && (($row['DEVF'] != '566') && $row['DEVF'] != '-')
                 && ($row['TYP'] == '110')) {
                    $tran_type = 'FX_INWARD';
                    $transmode_code = 'C';
                    $funds_code = 'B';
                ...
                */
                ...
                if (!empty($data) && (!empty($currency_name))) {
                    ...
                    $bind = [
                            'T_ACCOUNT_NUMBER' => $row['ACCOUNT_DEBITED'],
