...
class offLimitsUpdate extends Command
{
    protected $signature = 'execute-quer';
    ...
    public function handle()
    {
        ...
        where a.mon1 >= 200000 and a.ncp1 = b.ncp and a.age1 = b.age AND (trim(b.cha) in ('201001','201002','201004','201007','201012','201013','202001','202003','202004','202006',
        '202015','202016','202018','202008','202009','202010','202011','202017','202012','202013',
        '202014')) and a.dev1 = b.dev 
...
while ($result = oci_fetch_assoc($oracleStatement)) {
   ...
   // echo $result['CURRENT_BALANCE'];
               ...
               $pgsqlInsertQuery = "INSERT INTO tnx_above_1m (
