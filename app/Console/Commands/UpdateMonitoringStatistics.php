...
class UpdateMonitoringStatistics extends Command
{
    /**
     ...
     */
    protected $signature = 'statistics:update-2';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $query = "SELECT * FROM COMPLIANCE_STATISTICS WHERE STATUS='active' and categ = 'monitori'";
            ...
            while ($row = oci_fetch_assoc($stmt)) {
               ...
               // $localConn = oci_connect($Lusername, $Lpassword, $localTns);
                ...
                if ($result) {
                    ...
                    $updateQuery = "UPDATE COMPLIANCE_STATISTICS SET VAL = :val, last_updated = SYSTIMESTAMP WHERE ID = :id ";
